...
describe Decidim::Debates::CreateDebateEvent do
  ...
  let(:resource) { create :debate, :citizen_author, title: title }
  let(:title) { Decidim::Faker::Localized.localized { "<script>alert(\"TITLE\");</script> " + generate(:title) } }
    ...
    describe "email_subject" do
      ...
      context "when title has diacritics" do
        ...
        it "is generated correctly" do
          ...
          expect(subject.email_subject).to include("&lt;script&gt;alert(\"TITLE\");&lt;/script&gt; I'm a subject with diacritics !")
