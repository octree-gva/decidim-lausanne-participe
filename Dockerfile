...
########################################################################
FROM git.octree.ch:4567/decidim/decidim-quickstart/0.23:toolkit-alpine-latest
LABEL maintainer="hello@octree.ch"
